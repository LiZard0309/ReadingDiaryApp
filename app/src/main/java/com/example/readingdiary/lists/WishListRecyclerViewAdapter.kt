...
class WishListRecyclerViewAdapter(var books: ArrayList<Book>) : RecyclerView.Adapter<BookViewHolder>() {
    ...
    override fun onBindViewHolder(holder: BookViewHolder, position: Int) {
        ...
        holder.bookItemRootView.setOnClickListener {
            ...
            navHostFragment.navigate(WishListFragmentDirections.actionWishListFragmentToBookDetailsFragment(book))
        }
